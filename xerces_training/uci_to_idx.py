...
# https://github.com/trevor-graffa/lczero_tools/blob/master/src/lcztools/_uci_to_idx.py
...
_idx_to_uci_wn = {v: k for k, v in uci_to_idx[0].items()}
_idx_to_uci_wc = {v: k for k, v in uci_to_idx[1].items()}
_idx_to_uci_bn = {v: k for k, v in uci_to_idx[2].items()}
_idx_to_uci_bc = {v: k for k, v in uci_to_idx[3].items()}
